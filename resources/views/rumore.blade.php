...
<head>
    ...
    <style>
        ...
        .box { border: 1px solid blue; padding: 1em; margin: 1em 0;}
        body{display: flex; flex-direction: column; align-items: center; font-family:Arial, Helvetica, sans-serif;}
        
        input[type=text],input[type=email]{
            width: 100%;
        }
        button{
            width: 100%; background: none; border: solid blue; padding: 1rem 2rem
        }
    </style>
</head>
<body>
    ...
    <form method="POST" action="{{ route('iscrizione.store') }}" x-data="formData()">
        ...
        <div><small>La tessera associativa ha un costo di 10€ e va versata all'iscrizione :) Fallo immediatamente! <a href="https://forms.gle/o531HuN5Rt7XyVzJ7" target="_blank">Iscriviti cliccando qua</a></small></div><br>
        ...
        <br><br>
            ...
            <b>Cose da fare</b>: aiuto con installazioni, cucina, gestione workshop e spazi<br>
             Per ringraziarti dell’aiuto: ingresso ridotto al festival (30€) + pasti compresi<br></i>

            
        </label><br><br>

        <template x-if="volontari">
            <div class="box">

                <a href="mailto:">Grazie! Per favore scrivici una mail immediatamente! (Ma invia il form in ogni caso)</a></p>

                <label>Se hai allergie, intolleranze, diete specifiche (veganə/vegetarianə..) scrivilo qua sotto:</label><br>
        ...
        <template x-if="!volontari">
            <div>
                <div class="box" x-data="{ cibo: true }">
                    ...
                    <div>NB. Costo pasti ven-dom: 40 euro<br>
                    NBB. Si possono portare cibo e bere da casa, ma <b>non si possono usare fornelli da campeggio!</b> <br>
                    Il paesino più vicino è a 20 minuti di macchina per eventuali rifornimenti. <br>
                    NBBB. Per motivi logistici, offriamo un pacchetto cibo solo per tutta la durata del festival, <br>
